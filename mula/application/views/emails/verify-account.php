                                       ...
                                       <td width="100%">
                                          ...
                                          <div style="padding-top:20px;">
                                             <div style="font-size:14px;">
                                                <p>Please click on link below for verify your account.</p>
                                                 <a href="<?= $verify_link; ?>" style="background-color:#1f497d; color:#fff; padding:10px; width:100px; display:inline-block; text-align:center; text-decoration:none; border-radius:3px;">Click here</a>
                                             </div>
                                          </div>
                                       </td>
                                    </tr>
                        ...
                        <table bgcolor="#fff" style="font-family: sans-serif; background-color:#fff;" width="100%;" cellpadding="0" cellspacing="0">
                           ...
                           <tr>
                              <td style="color:#333; background-color:#fff; border-top:1px solid #ddd;">
                                 <p style="margin:0;font-size:12px;padding:11px 40px;text-align:center;">&copy; Copyright <?= date("Y"); ?> MULA Ptv. Ltd. | All Rights Reserved.</p>
                              </td>
                           </tr>
                           </td>
                           </tr>
