                           ...
                           <tr bgcolor="#fff" style="">
                              <td style="padding:30px  40px 30px;">
                                 <table style="font-family: sans-serif;" width="100%">
                                    <tr>
                                       <td width="100%">
                                          <p style="font-size:16px;margin:4px 0;margin: 0 0;">Hello, <strong style="font-size:20px;color:#1f497d;">Author</strong></p>
                                          </h4>
                                          <div style="padding-top:20px;">
                                             <div style="font-size:14px;">
                                                <p>New contact request arrived please check details below:</p>
